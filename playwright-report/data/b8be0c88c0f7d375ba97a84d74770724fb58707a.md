...
- generic [ref=e1]:
        ...
        - generic [ref=e27]:
          ...
          - generic [ref=e55]:
            - generic [ref=e56]:
              - paragraph [ref=e58]:
                - img [ref=e60]
                - generic [ref=e64]: src/app/faculty/cases/new/actions.ts (43:19) @ createCaseAction
            ...
            - generic [ref=e85]:
              - generic [ref=e86]:
                - paragraph [ref=e87]:
                  - text: Call Stack
                  - generic [ref=e88]: "60"
                - button "Show 56 ignore-listed frame(s)" [ref=e89] [cursor=pointer]:
                  - text: Show 56 ignore-listed frame(s)
                  - img [ref=e90] [cursor=pointer]
              - generic [ref=e92]:
                - generic [ref=e93]:
                  - text: createCaseAction
                  - button "Open createCaseAction in editor" [ref=e94] [cursor=pointer]:
                    - img [ref=e95] [cursor=pointer]
                - generic [ref=e97]: src/app/faculty/cases/new/actions.ts (43:19)
              - generic [ref=e98]:
                - generic [ref=e99]:
                  - text: createCaseAction
                  - button "Open createCaseAction in editor" [ref=e100] [cursor=pointer]:
                    - img [ref=e101] [cursor=pointer]
                - generic [ref=e103]: src/app/faculty/cases/new/actions.ts (8:23)
              - generic [ref=e104]:
                - generic [ref=e105]: form
                - generic [ref=e106]: unknown (0:0)
              - generic [ref=e107]:
                - generic [ref=e108]:
                  - text: NewCasePage
  ...
  - generic [ref=e136]:
    - 'heading "Application error: a server-side exception has occurred while loading localhost (see the server logs for more information)." [level=2] [ref=e137]'
    - paragraph [ref=e138]: "Digest: 2954198234"
```